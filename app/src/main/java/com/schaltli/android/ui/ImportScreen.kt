...
fun ImportScreen(
    ...
    Column(
        ...
        Text(text = "Schaltli", style = MaterialTheme.typography.titleLarge)
        Text(
            text = "Import a project exported from the Schaltli designer's \"Android Phone\" device to get started.",
