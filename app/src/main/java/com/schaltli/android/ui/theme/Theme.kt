package com.schaltli.android.ui.theme
...
private val LightColors = lightColorScheme(
    primary = SchaltliBlue,
    background = SchaltliBackground,
    surface = SchaltliSurface,
)

private val DarkColors = darkColorScheme(
    primary = SchaltliBlueDark,
    background = SchaltliBackgroundDark,
    surface = SchaltliSurfaceDark,
)
